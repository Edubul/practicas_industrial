        ...
        <nav class="bg-white border-b border-gray-200 fixed z-30 w-full">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    ...
                    <img src="/img/logo_lii.png" class="h-6 mr-2" alt="Windster Logo">
                    <span class="self-center whitespace-nowrap">Laboratorio Industrial</span>
                    </a>
        ...
        <div class="flex overflow-hidden bg-white pt-16">
                ...
                <div class="relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
                    ...
                    <div class="flex-1 px-3 bg-white divide-y space-y-1">
                        <ul class="space-y-2 pb-2">
                            ...
                            <li>
                                <Link :href="route('dashboard.index')" class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group">
                            ...
                            <li>
                                <Link :href="route('inventario.index')" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                                <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path>
                                </svg>
                                <span class="ml-3 flex-1 whitespace-nowrap">Inventario</span>
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <span class="ml-3 flex-1 whitespace-nowrap">Prácticas</span>
                                </Link>
                            </li>
                            <li>
            ...
            <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-64">
                ...
                <p class="text-center text-sm text-gray-500 my-10">
                    &copy; 2022 <a href="#" class="hover:underline" target="_blank">Laboratorio Industrial</a>. <br> Hecho con ❤ por servicio social.
                </p>
            </div>
        </div>
    </div>
